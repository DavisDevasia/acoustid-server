...
from acoustic.web.utils import require_user
from acoustic.models import TrackMBIDChange, TrackMeta
from acoustic.data.track import resolve_track_gid
from acoustic.data.musicbrainz import lookup_recording_metadata
from acoustic.data.account import is_moderator
from acoustic.utils import generate_api_key, is_uuid
...
def mbid(mbid):
    from acoustic.data.track import lookup_tracks
    from acoustic.data.musicbrainz import lookup_recording_metadata
    conn = db.session.connection()
