...
from acoustic.script import Script
from acoustic.web import db
from acoustic.web.views.general import general_page
from acoustic.web.views.user import user_page
from acoustic.web.views.apps import apps_page
from acoustic.web.views.metadata import metadata_page
from acoustic.web.views.stats import stats_page
from acoustic.web.views.admin import admin_page
...
if __name__ == "__main__":
    ...
    from acoustic.server import make_application as make_api_application
